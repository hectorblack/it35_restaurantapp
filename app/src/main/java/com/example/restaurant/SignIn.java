                ...
                table_user.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(snapshot.child(txtPhone.getText().toString()).exists()){
                            ...
                            mDialog.dismiss();
                            User user = snapshot.child(txtPhone.getText().toString()).getValue(User.class);

                            if(user.getPassword().equals(txtPassword.getText().toString())){
                                //Toast.makeText(SignIn.this,"Sign in Successful...",Toast.LENGTH_SHORT).show();
                                userid =txtPhone.getText().toString();
                                Intent MainHome = new Intent(SignIn.this,MainHome.class);
                                startActivity(MainHome);
                            }
                            else{
                                Toast.makeText(SignIn.this,"Incorrect Password, Try again...",Toast.LENGTH_SHORT).show();
                            }
